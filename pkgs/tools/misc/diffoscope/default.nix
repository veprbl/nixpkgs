...
python3Packages.buildPythonApplication rec {
  ...
  patches = [
    ./ignore_links.patch
    ./remove-sbin-test.patch
  ];

  # Still missing these tools: abootimg docx2txt enjarify js-beautify oggDump Rscript
  ...
  pythonPath = with python3Packages; [ debian libarchive-c python_magic tlsh rpm ] ++ [
    ...
    ] ++ lib.optional doCheck pytest;

  doCheck = true; # Calls 'mknod' in squashfs tests, which needs root
