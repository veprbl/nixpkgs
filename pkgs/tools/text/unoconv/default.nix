{ stdenv, fetchFromGitHub, python3, libreoffice-fresh-unwrapped, asciidoc, makeWrapper
...
stdenv.mkDerivation rec {
  ...
  postInstall = ''
    ...
    wrapProgram "$out/bin/unoconv" --set UNO_PATH "${libreoffice-fresh-unwrapped}/lib/libreoffice/program/"
