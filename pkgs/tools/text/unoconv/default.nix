{ stdenv, fetchFromGitHub, python3, libreoffice, asciidoc, makeWrapper
...
stdenv.mkDerivation rec {
  ...
  postInstall = ''
    ...
    wrapProgram "$out/bin/unoconv" --set UNO_PATH "${libreoffice.libreoffice}/lib/libreoffice/program/"
