{ stdenv, fetchurl, imake, libXt, libXaw, libXtst, libXi, libXpm, xorgproto, gccmakedep, Xaw3d }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ imake libXt libXaw libXtst xorgproto libXi Xaw3d libXpm gccmakedep ];
