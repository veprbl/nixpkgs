...
let
  ...
  xorgserver = (mkDerivation "xorgserver" {
    name = "xorg-server-1.18.99.901";
    builder = ./builder.sh;
    src = fetchurl {
      url = mirror://xorg/individual/xserver/xorg-server-1.18.99.901.tar.bz2;
      sha256 = "757c0c815b1b07cb9e039664dcad9653dfaa689ca530b10efafc266b9ee07c65";
    };
