{ stdenv, fetchurl
, libX11, libXext, libXi, libXrandr, libXrender, ncurses, pkgconfig
, xorgserver, xorgproto, udev, libXinerama, pixman }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ libX11 libXext libXi libXrandr libXrender ncurses pkgconfig xorgserver
      xorgproto udev libXinerama pixman
    ];
