{ fetchpatch, fetchurl, stdenv, libGLU, freeglut, libX11, plib, openal, freealut, libXrandr
, libXext, libSM, libICE, libXi, libXt, libXrender, libXxf86vm, libvorbis, xorgproto
