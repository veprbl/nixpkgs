...
stdenv.mkDerivation rec {
  ...
  mesonFlags = [
    ...
    "-Dmusepack=disabled" # as of writing, with `libmpcdec` in `buildInputs` we get "Could not find libmpcdec header files, but Musepack was enabled via options"; libmpcdec packaging problem?
