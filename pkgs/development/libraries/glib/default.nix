{ stdenv, fetchurl, gettext, meson, ninja, pkgconfig, perl, python3
, libiconv, zlib, libffi, pcre, libelf, gnome3, libselinux, bash, gnum4
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "1xkpvdzzm93j1n9javga2gpc51x80ra3nq8inx3mrydl603wxx60";
  };
  ...
  nativeBuildInputs = [ meson ninja pkgconfig perl python3 gettext ];
