{ stdenv, fetchurl, fetchpatch, pkgconfig, freetype, expat, gperf, libxslt, dejavu_fonts
, substituteAll }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "0p7428wzhpj5qpz4vhnwks3w148hjh2ywp7frmjrgidkqky970k6";
  };
  ...
  buildInputs = [ pkgconfig expat gperf ];
