...
{ stdenv, fetchFromGitHub, pkgconfig, autoconf, automake, which, mono, dotnetbuildhelpers, dotnetPackages }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "fsharp";
    rev = version;
    sha256 = "02z27kbp4ahm6r8hbfpiybq2l2nqlv1vcwlmgdcjwmcy3kjhijwz";
  };
