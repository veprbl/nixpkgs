...
stdenv.mkDerivation rec {
  ...
  preConfigure = ''
    ...
    export LD="${targetCC.bintools}/bin/${targetCC.bintools.targetPrefix}ld${stdenv.lib.optionalString (targetPlatform.isArm || targetPlatform.isAarch64) ".gold"}"
  ...
  ] ++ stdenv.lib.optionals (targetPlatform.isArm || targetPlatform.isAarch64) [
    "CFLAGS=-fuse-ld=gold"
