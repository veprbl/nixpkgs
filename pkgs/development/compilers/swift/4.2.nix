...
let
  ...
  sources = {
    ...
    clang = fetch {
      repo = "swift-clang";
      sha256 = "030b5di20zwb5iclsgh9r45vzzcp8p59i4mzcr3hkw19yczv4kv5";
    };
    llvm = fetch {
      repo = "swift-llvm";
      sha256 = "1z2bcdr528278gmwg1x125hajla5krvjrgsxim9ljbrphb0z52ym";
    };
    compilerrt = fetch {
      repo = "swift-compiler-rt";
      sha256 = "1h648g2w7m54db1nqz640v4s08a70icpsqpaxvwa407mq8lfyj20";
    };
    cmark = fetch {
      repo = "swift-cmark";
    ...
    lldb = fetch {
      repo = "swift-lldb";
      sha256 = "0439y4d8llkvz5l9lzc0f1l8gs26i9ah0j3bwy912l612hai4hqq";
    };
    llbuild = fetch {
      repo = "swift-llbuild";
      sha256 = "1a1gbics6wa1z69c46apvizqnjxx51pqq5fgspvmdfxpizipn63m";
    };
    pm = fetch {
      repo = "swift-package-manager";
      sha256 = "0dy53mlf95i3zzsjws0m9qas89m96nzlqwh6771d1xzwryhxwhws";
    };
    xctest = fetch {
    ...
    foundation = fetch {
      ...
      sha256 = "1d3v193fkfhmha8365c13c8c0rb7gfl8w5w8ay49wl4lad4v2qdq";
    };
    libdispatch = fetch {
      repo = "swift-corelibs-libdispatch";
      sha256 = "0dwjpm8ak3hd6kn8ka6mnbbvknbd5w9cmjn4c2bwd9zkzzxzvllx";
      fetchSubmodules = true;
    };
    swift = fetch {
      repo = "swift";
      sha256 = "0dwxl4mlh8n82f79kfpv3qa8mywzmcbj2csc8hq8w3mp4hbrxfcx";
    };
  };
