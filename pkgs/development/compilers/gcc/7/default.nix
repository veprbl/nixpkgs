...
let version = "7.2.0";
    ...
    patches =
      ...
      ++ optional targetPlatform.isMusl (fetchpatch { # XXX: Refine when this should be applied
...
stdenv.mkDerivation ({
  ...
  configureFlags =
    ...
    ++ optional (targetPlatform == hostPlatform && targetPlatform.isMusl) "--disable-libsanitizer"
  ;
