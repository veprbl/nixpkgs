{ stdenv, hostPlatform, buildPlatform, fetchurl }:
...
stdenv.mkDerivation rec {
  ...
  patches = [ ./s_isdir.patch ] ++ stdenv.lib.optional (hostPlatform.isDarwin && buildPlatform.isDarwin) stdenv.secure-format-patch;
