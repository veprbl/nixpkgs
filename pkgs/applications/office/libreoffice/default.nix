...
, icu, boost, jdk, ant, cups, xorg, libcmis, mariadb
...
let
  ...
  srcs = {
    ...
    translations = fetchSrc {
      name = "translations";
      sha256 = "00vy7piw09dfrf092zw7fa7713fln7qd3hh3jhx5m9v6wcvc2rci";
    };
    ...
    help = fetchSrc {
      name = "help";
      sha256 = "1k41sia7xy8q8jdrkndxzflrrg1s6q0f26xg0lj5g0kijb7wgrx6";
    };
