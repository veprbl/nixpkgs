...
, gtk, gnome3, gnome-autoar, dbus-glib, glib-networking, shared-mime-info, libnotify, libexif, libseccomp
...
in stdenv.mkDerivation rec {
  ...
  buildInputs = [
    dbus-glib glib-networking shared-mime-info libexif gtk exempi libnotify libselinux
