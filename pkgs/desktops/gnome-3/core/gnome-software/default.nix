...
, gtk3, gsettings-desktop-schemas, gnome-desktop, libxmlb, gnome-online-accounts, hicolor-icon-theme, glib-networking
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    gtk3 glib glib-networking packagekit appstream-glib libsoup
