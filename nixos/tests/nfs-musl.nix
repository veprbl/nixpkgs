...
let
  ...
  client =
    ...
    { fileSystems = pkgs.lib.mkVMOverride
      ...
      imports = [ ../modules/config/musl.nix ];
    };
...

{
  ...
  testScript =
    ''
      ...
      $client2->succeed("command -v flock >&2; readlink -f `command -v flock` >&2; flock -x --verbose /data/lock -c 'echo acquired; touch locked; sleep 100000' >&2 &");
