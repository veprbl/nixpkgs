  ...
  userOpts = { name, config, ... }: {
    ...
    options = {
      ...
      name = mkOption {
        ...
        description = ''
          The name of the user account. If undefined, the name of the attribute
          set will be used.
        '';
      };
      ...
      password = mkOption {
        ...
        default = null;
        description = ''
          The user's password in clear text. If undefined, no password is set
          for the user. Warning: do not set confidential information here
          because this data would be readable by all. This option should only
          be used for public accounts such as guest accounts.
      ...
      createUser = mkOption {
        ...
        description = "
          ...
          then not add the user to the local passwd file.
        ";
      };
    };
  ...
  groupOpts = { name, config, ... }: {
    ...
    options = {
      ...
      name = mkOption {
        type = with types; uniq string;
        description = ''
          The name of the group. If undefined, the name of the attribute
          set will be used.
        '';
      };
