  ...
  options = {
    ...
    services.couchdb = {
      ...
      databaseDir = mkOption {
        type = types.path;
        default = "${config.services.dataPrefix}/lib/couchdb";
        description = ''
      ...
      uriFile = mkOption {
        type = types.path;
        default = "${config.services.dataPrefix}/run/couchdb/couchdb.uri";
        description = ''
      ...
      logFile = mkOption {
        type = types.path;
        default = "${config.services.dataPrefix}/log/couchdb.log";
        description = ''
